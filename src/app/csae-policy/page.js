...
export const metadata = {
  ...
  description:
    "Ments standards, procedures and commitment to combating child sexual abuse and exploitation (CSAE).",
};
...
export default function CsaePolicyPage() {
  return (
    <div className="interior document-page csae-policy-page">
      <SiteNav />
      <main id="main">
        <div className="container">
          <header className="legal-hero">
            ...
            <p className="legal-intro">
              At Ments (&ldquo;the App&rdquo;), we are committed to creating a
              safe environment for all users, with a particular focus on
              protecting children from sexual abuse and exploitation. This
              policy outlines our standards, procedures, and commitment to
              combating child sexual abuse and exploitation (CSAE) in all forms.
            </p>
          </header>

          <div className="legal-layout">
            <aside className="legal-toc">
              <div className="legal-toc-label">IN THIS POLICY</div>
              {CLAUSES.map((clause, index) => (
                <a href={`#clause-${index + 1}`} key={clause.title}>
              ...
              <a href="mailto:support@ments.app" className="policy-contact">
                Report a concern ↗
              </a>
            </aside>
